...
try {
  ...
  console.error('Could not find valid configuration file- application will now quit.');
  process.exit(1);
}
...
passport.use(new RedditStrategy({
    clientID: CONFIG.REDDIT_CONSUMER_KEY_WEB,
    clientSecret: CONFIG.REDDIT_CONSUMER_SECRET_WEB,
